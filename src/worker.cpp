                         ...
                         const std::map<std::string, std::string> &kv)
{
    ...
    {
        log("WORKER  MAP task=" + std::to_string(task_id) + " FAILED: " + e.what());
                            ...
                            const std::map<std::string, std::string> &kv)
{
    ...
    {
        log("WORKER  REDUCE task=" + std::to_string(task_id) + " FAILED: " + e.what());
        return;
    }
...
int main(int argc, char *argv[])
{
    ...
    log("WORKER  pid=" + std::to_string(worker_id) + "  connecting to master " + master_host + ":" + std::to_string(MASTER_PORT));
